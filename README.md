...
- docs/
    - ウェブサイトとして公開する用
- epub/
    - 元々電子書籍にして自分で読む用だった。今はもうウェブサイトでいい
- memo/
    - 生成 AI 用作業フォルダ
- ===
- settings/
...
- 1: プロットや設定をこねこね
- 2: 下書き
    - ~~ポメラでゴリゴリ書き始める~~ 生産性出ないので PC + エディタで良い
    - 最初は台詞だけとかでもいい
    - 少しずつ肉付けしていく
- 3: 清書
...
- tag はきりの良いタイミングで適当につけてる
    ...
    - 予約投稿開始前
    - 予約投稿全部終わった etc
    - 最近全然つけてないですね…… 2023/11/11

### 生成 AI 運用
Claude を使っています。

- 2026-07-29 現在
    - memo/ 配下を作業スペースにしつつ、色々やっている
    - 直近では原稿全部を docs/index.html で公開した（読みやすいデザインや目次もつけて外出先からも読めるようにした）
